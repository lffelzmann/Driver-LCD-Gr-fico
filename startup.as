	...
	; Compiler options:
	;
	; -oTesteUnitarioLCDGrafico.cof -mTesteUnitarioLCDGrafico.map \
	; --summary=default --output=default lcd_grafico.p1 recursos_texto.p1 \
	; unit_test.p1 delays.p1 bitmap.p1 --chip=16F886 -P --runtime=default \
